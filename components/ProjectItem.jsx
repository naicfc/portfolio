...
const ProjectItem = ({title, backgroundImg, projectUrl, stack}) => {
  return (
    <div className='relative flex items-center justify-center h-auto shadow-lg dark:shadow-md shadow-gray-400 rounded-xl p-4 group hover:bg-gradient-to-r from-[#4169e1] to-[#a9b2cc]'>
