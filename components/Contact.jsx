...
function Contact() {
  return (
    <div id='contact' className='w-full  py-16 pt-20'>
        <div className='max-w-[1240px] m-auto px-2 w-full'>
        <p className='text-xl mb-2 tracking-widest uppercase font-semibold text-[#4169e1] text-center'>Contact</p>
        <p className='text-gray-600 text-center mb-8'>Fill out the form and i will reach out as soon as possible.</p>
          <div className='flex flex-col lg:flex-row items-center justify-center gap-8 '>
            <div className='w-full md:w-[80%] p-8'>
              <div className="flex flex-col gap-2 ">
              <h2 className='lg:text-5xl mb-2 text-gray-700'>Let's chat.<br></br> Tell me about your project.</h2>
              <p className='text-gray-600 mb-8'>Let's create something together.</p>
              <div className='pt-4'>
                ...
                <div className='flex items-center justify-start my-4 w-full '>
                  <div className='rounded-full shadow-lg shadow-gray-400 p-4 mr-8 cursor-pointer hover:scale-105 ease-in duration-300'>
                    <FaLinkedinIn />
                  </div>
                  <div className='rounded-full shadow-lg shadow-gray-400 p-4 mr-8 cursor-pointer hover:scale-105 ease-in duration-300'>
                    <FaGithub className=''/>
            ...
            <div className='p-4 w-[100%]'>
              <form action="https://formsubmit.co/godfrednai@gmail.com" method="post">
                ...
                <label for='name' className='font-semibold text-gray-600'>Name</label>
                ...
                <label for='email' className='font-semibold text-gray-600'>E-mail</label>
                ...
                <label for='message' className='font-semibold text-gray-600'>Message</label>
