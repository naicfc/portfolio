  ...
  return (
    <div id='projects' className='min-h-screen p-8 xl:p-16 dark:bg-[#102A43]'>
        <div className='text-center'>
            <p className='text-xl tracking-widest uppercase font-semibold text-[#4169e1] dark:text-white mt-8 mb-4'>Projects</p>
            <p className='text-gray-600 text-center mb-8 dark:text-white'>Here are some of my most recent projects</p>
        </div>
