...
function Skill() {
  return (
    <div id='skills' className='w-full md:h-screen p-4 flex items-center justify-center py-16 bg-white dark:bg-[#102A43] '>
        <div className='max-w-[1240px]  md:grid md:gap-0 sm:grid-cols-2 gap-12'>
            <div className='mb-12'>
                <div>
                    <p className='text-center md:text-left font-semibold md:pl-8 uppercase text-xl tracking-widest text-[#4169e1] dark:text-white'>Skills</p>
                </div>
            ...
            <div className='flex flex-col md:flex-row gap-8'>
                <div className='p-[1px] mb-8 md:mb-0 md:mr-4 bg-[#4169e1] dark:bg-white rounded-full lg:translate-x-5 xl:translate-x-7'></div>
                <div className='px-8'>
                <div>
